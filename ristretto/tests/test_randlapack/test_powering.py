...
import ristretto.tests.test_randlapack.utilities as test_util
...
class TestPSO1(unittest.TestCase):
    ...
    def _test_max_eig(self, ps):
        ...
        for n_rows in rows:
            for n_cols in cols:
                A = test_util.rand_low_rank(n_rows, n_cols, spectrum, rng)
